            ...
            with self.get_connection() as conn:
                ...
                for row in rows:
                    ...
                    alert = Alert(
                        ...
                        raw_packet=(None if row_dict.get("raw_packet") is None else (
                            row_dict.get("raw_packet") if isinstance(row_dict.get("raw_packet"), str) else base64.b64encode(row_dict.get("raw_packet")).decode('ascii')
                        )),
